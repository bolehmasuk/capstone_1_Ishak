...
def buat_koneksi():
    """Membuat koneksi ke database MySQL dengan password"""
    try:
        # Menggunakan format user@host dengan password
        ...
        print("Selamat datang di Toko RESEP BUNDA, terima kasih telah berkunjung!")
        return engine
